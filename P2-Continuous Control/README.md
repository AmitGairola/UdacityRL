...
For this project, I used the second version which contains 20 identical agents, each with its own copy of the environment.  
...
Place the file “Continuous_Control-MultipleAgentsv4Final.ipynb” in the folder and follow the execution steps in the ipython notebook.

Also need to ensure that Pytorch (version 2.0.1) is installed.
